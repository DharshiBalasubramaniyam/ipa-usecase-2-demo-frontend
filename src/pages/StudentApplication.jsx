...
function StudentApplication() {
    ...
    const handleSubmit = () => {
        ...
        console.log(form);
        setFinalForm(JSON.stringify(form, null, 3))
        setFormData({})
        setemergency({})
        setolResultDetails({})
        setolResultArr([])
                ...
                <h1 className="text-2xl font-bold mb-6 text-center">Student application form</h1>
                {
                    finalForm ? (
                        <div className="space-y-4">
                            <h2 className="text-xl font-semibold mb-4 text-center">Your response</h2>
                            <pre>{finalForm}</pre>
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="mt-3">
                                ...
                                <div className="border rounded-md p-4 mb-4 bg-gray-50">
                                    ...
                                    {
                                        olResultArr.map((res, index) => {
                                            return <p key={index} className='mt-1 text-bold'>{res?.subject} - {res?.grade}</p>
                                        })
                                    }
                                </div>
                            </div>
                            ...
                            <div className="border rounded-md p-4 mb-4 bg-gray-50">
                                ...
                                {
                                    otherQualificationArr.map((res, index) => {
                                        return <p key={index} className='mt-1 text-bold'>{res?.course} - {res?.nvq} - {res?.institute} - {res?.year} - {res?.result}</p>
                                    })
                                }
                            </div>
                            ...
                            <div className="border rounded-md p-4 mb-4 bg-gray-50">
                                ...
                                {
                                    refreeArr.map((res, index) => {
                                        return <p key={index} className='mt-1 text-bold'>{res?.name} - {res?.designation} - {res?.address} - {res?.mobile}</p>
                                    })
                                }
                            </div>
